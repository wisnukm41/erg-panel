  ...
  <div class="bootstrap-iso">
    ...
    <!-- Content Header (Page header) -->
      <div class="content-header">
        <div class="row mb-2">
          <div class="col-sm">
            <h1 class="m-0 text-dark">Tambah Acara</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
    </div>
    <!-- /.content-header -->
    ...
    <div class="card">
      <div class="card-header">
        <a href="<?= base_url('admin/event') ?>">Kembali</a>
      </div>
      <!-- /.card-header -->
      <!-- form start -->
      <form role="form" action="<?= base_url('admin/event/add') ?>" method=post enctype="multipart/form-data">
        <div class="card-body">
          <div class="form-group">
            <label for="eventName">Topic</label>
            <input type="text" class="form-control" id="eventName" placeholder="Enter event topic" name='name'>
          </div>
